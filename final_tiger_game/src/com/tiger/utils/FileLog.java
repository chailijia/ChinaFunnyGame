...
public class FileLog {
	...
	private static String LOGFILENAME = "GameLog.txt"; // 本类输出的日志文件名称

	private static String LOG_PATH_SDCARD_DIR = Environment.getExternalStorageDirectory() + "/"; // 日志文件在sdcard中的路径
